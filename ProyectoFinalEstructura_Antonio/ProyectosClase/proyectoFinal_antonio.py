...
#------- No lo ponga en pendiente, tengo muchas cosas ahorita en la cabeza para enfocarme en esto, una disculpa doy para más -------
#----Menú principal----
# !TODO Preguntarle a rafa si se puede importar una clase que esta dentro de otra carpeta
print("\033[1;33m" + "¡Bienvenido Al Proyecto Final de Estructura de Antonio! \n" + "\033[0;m") #Esto es con código ANSI
print("\033[5;32m" + "La manera en la que funciona el programa es la siguiente: \n Se ingresarán x cantidad de datos según la elección del usuario \n Cuando estos datos hayan sido recabados se despliega el menú con las estructuras de datos \n El usuario comienza a manipular sus datos y al final cuando decida no cambiarlos, serán los nuevos datos para la siguiente estructura! \n" + "\033[0;m")
menuPrincip = int(input("\033[1:33m"+" 1-Ingresar datos \n 2-Salir \n Respuesta: "+ "\033[0;m")) 
while menuPrincip != 2:
    #Ingresar los datos
    if menuPrincip == 1:
        datos = int(input ("\033[1;35m" + "Ingresa la cantidad de datos que quieres meter a tu lista: \n" + "\033[0;m"))
        listaDatos = []
        ...
        while True:
            estAusar = int(input("\033[1;34m"+"¿Con qué estructura de datos te gustaría trabajar? \n 1 - Pila Estática \n 2 - Pila Dinámica \n 3 - Lista Ligada \n 4 - Árboles \n 5 - Cola Estática \n 6 - Cola Dinámica \n 7 - Cola Circular \n 8 - Salir \n Respuesta: " + "\033[0;m"))
            if estAusar == 8:
                break
            #Caso Pila Estática
            if estAusar == 1:
            ...
            # #Caso Cola Dinámica
            # Algo está mal con mi loop para cola dinámica y circular. Intenté arreglarlo pero por causuas agenas a mi internaron a mi mamá y dejé todo en casa para cuidarla
            if estAusar == 6:
                colaD = ColaD()
                for i in range (len(listaDatos)):
    ...
    menuPrincip = int(input("\033[1:36m"+" \n 1-Ingresar datos \n 2-Salir \n Respuesta: " +"\033[0;m"))
